...
def main():
    ...
    template = cv2.imread('notev2.jpg',0)
    ...
    while(True):
        ...
        rets, labels, centers = cv2.kmeans(np.array(closePoints,dtype=np.float32),10,None,(cv2.TERM_CRITERIA_EPS | cv2.TERM_CRITERIA_MAX_ITER, 1, 10),1,cv2.KMEANS_RANDOM_CENTERS)
